...
# Compute the difference (subtraction) between original and corrected MIPs
...
# Difference between Corrected and Original MIP
ax[2].imshow(mip_difference, cmap='gray')
ax[2].set_title('Difference (Corrected - Original)')
ax[2].axis('off')
